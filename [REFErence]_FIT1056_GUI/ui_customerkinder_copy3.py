...
class ResultsFrame(ctk.CTkFrame):
    ...
    def display_chart(self, data, bg_color="transparent"):
        """Generate and display a donut chart for the highest activity only
        and a horizontal bar graph for the top 3 activities.
        :param data: Dictionary with activity names as keys and values as percentages (0-100).
    ...
    """
        ...
        widget.configure(bg='#212121', highlightthickness=0, borderwidth=0)
